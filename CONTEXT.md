...
- first-run wizard step labels: the initial step sequence is Cloud, Server, Hermes, Gateways, Review. Use Gateways rather than Telegram so the step can cover Telegram now and future gateway types later.
